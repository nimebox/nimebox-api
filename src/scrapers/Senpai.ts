...
export default class Senpai extends BaseScraper {
  ...
  public async getAnimeList(): Promise<any[]> {
    try {
      ...
      const obj = {
        title: [...doc.querySelectorAll('div[class="collection row anime-col"] > a[class="collection-item anime-item col l6 m6 s12"] > div[class="anime-desc"] > span[class="title anime-title"]')],
        url: [...doc.querySelectorAll('div[class="collection row anime-col"] > a[class="collection-item anime-item col l6 m6 s12"][href]')],
        image: [...doc.querySelectorAll('div[class="collection row anime-col"] > a[class="collection-item anime-item col l6 m6 s12"] > img[class="anime-cover"][src]')],
      }
  ...
  public async getAnime(animeTitle: string): Promise<IBaseScraperResponse[]> {
    try {
      ...
      const obj = {
        title: [...doc.querySelectorAll('div[class="collection row anime-col"] > a[class="collection-item anime-item"] > div[class="anime-number"] > h5')],
        url: [...doc.querySelectorAll('div[class="collection row anime-col"] > a[class="collection-item anime-item"][href]')],
      }
      return obj.title.map((el, i) => {
        return ({
          title: el.textContent.trim(),
