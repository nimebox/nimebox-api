      ...
      const obj = {
        title: [
          ...doc.querySelectorAll(
            'div[class="news-module"] > div[class="news"] > div[class="news-info-bar"] > div[class="news-title-bar float-left"] > div[class="news-title"] > a:nth-of-type(2)'
          )
        ],
        url: [
          ...doc.querySelectorAll(
            'div[class="news-module"] > div[class="news"] > div[class="news-info-bar"] > div[class="news-title-bar float-left"] > div[class="news-title"] > a[href]'
          )
        ],
        date: [
          ...doc.querySelectorAll(
            'div[class="news-module"] > div[class="news"] > div[class="news-info-bar"] > div[class="news-title-bar float-left"] > div[class="news-date"]'
          )
        ],
        description: [...doc.querySelectorAll('div[class="news-module"] > div[class="news"] > div[class="news-desc"]')],
        image: [
          ...doc.querySelectorAll(
            'div[class="news-module"] > div[class="news"] > div[class="news-category-image"] > a > img[src]'
          )
        ]
      }
